...
class Build(models.Model):
    ...
    gallery_image_1 = models.ImageField(upload_to='images/', default='')
    gallery_image_2 = models.ImageField(upload_to='images/', default='')
    gallery_image_3 = models.ImageField(upload_to='images/', default='')
    gallery_image_4 = models.ImageField(upload_to='images/', default='')
